...
class Solutions_Leaps(models.Model):
    ...
    seed= models.IntegerField(null=True)
    reward_StairClimber = models.FloatField(null=True)
    reward_Maze = models.FloatField(null=True)
    reward_TopOff = models.FloatField(null=True)                
    reward_FourCorners = models.FloatField(null=True)                
    reward_Harvester = models.FloatField(null=True)                                
    reward_CleanHouse= models.FloatField(null=True)                                
    reward_DoorKey= models.FloatField(null=True)                                
    reward_OneStroke= models.FloatField(null=True)                                
    reward_Seeder= models.FloatField(null=True)                                
    reward_Snake = models.FloatField(null=True)                                
...
def plot_results(experiment):
    ...
    methods = [        
        '1StochasticHillClimbingDictMultSize',
        # 'StochasticHillClimbingDictMultSize2',
        # 'StochasticHillClimbingDictMultSize3',
        # 'StochasticHillClimbingDictMultSize4',
        'StochasticHillClimbingDictMultSize5',
        # 'StochasticHillClimbingDictMultSize6',
        'StochasticHillClimbingDictMultSize7',
        #'StochasticHillClimbingDictMultSize8',
        'StochasticHillClimbingDictMultSize9',
    ...
    fig.savefig(f'/home/rubens/pythonProjects/Karel-SHC/output/D_all_tasks_{experiment_name}.png', dpi=600, transparent=True)
    fig.savefig(f'/home/rubens/pythonProjects/Karel-SHC/output/D_all_tasks_{experiment_name}.pgf')
    fig.savefig(f'/home/rubens/pythonProjects/Karel-SHC/output/D_all_tasks_{experiment_name}.pdf')


if __name__ == '__main__':
    parser = ArgumentParser(formatter_class=ArgumentDefaultsHelpFormatter)
    
    parser.add_argument('--experiment', help='Name of the experiment', default='/home/rubens/pythonProjects/Karel-SHC/output/search_debug/')

...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', default='TopOff', help='Task class name')
    ...
    dsl = KarelDSL()
    for d_number in range(1,31):
        dict_program = []
        path_dic = '/home/rubens/plots/KarelLLM/KarelLLMMoreInf/datasets/dictionaries/dicLLM/dict'+str(d_number)+'.txt'
        ...
        for prog in dict_program:
            reward = evaluate_program(prog, dsl, task_envs)
            if reward >= 0:

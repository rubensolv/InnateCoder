...
def smooth_data(data, sigma=2):
        return data.apply(lambda x: gaussian_filter1d(x, sigma=sigma), axis=0)
...
def load_data(directory):
    ...
    data_seeds = smooth_data(data_seeds)
...
def plot_results(experiment):
    ...
    path_csv = '/home/rubens/pythonProjects/Karel-SHC/output/exp_iclr_crash/csv/'
    for i, task in enumerate(all_tasks):
        ...
        for method in methods:
            ...
            name_path = path_csv+task+str(i)+'_'+method+'_std.csv'
            data_std.to_csv(name_path)
        ...
        name_path = path_csv+task+str(i)+'_mean.csv'
        mean_table.to_csv(name_path)        
